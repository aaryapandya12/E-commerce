...
//   return (
//     <div className="flex items-center justify-between py-5 font-medium shadow-md bg-gray-50 ">
//       <Link to="/">
...
//   return (
//     <div className="flex items-center justify-between py-5 px-10 font-medium shadow-md bg-white w-full">
//       {/* Left - Logo */}
...
//         <NavLink to="/" className="flex flex-col items-center hover:text-black transition">
//           <p>HOME</p>
//           <hr className="w-full h-[1.5px] bg-gray-700 hidden" />
//         </NavLink>

//         <NavLink to="/collection" className="flex flex-col items-center hover:text-black transition">
//           <p>COLLECTION</p>
//           <hr className="w-full h-[1.5px] bg-gray-700 hidden" />
//         </NavLink>

//         <NavLink to="/about" className="flex flex-col items-center hover:text-black transition">
//           <p>ABOUT</p>
//           <hr className="w-full h-[1.5px] bg-gray-700 hidden" />
//         </NavLink>

//         <NavLink to="/contact" className="flex flex-col items-center hover:text-black transition">
//           <p>CONTACT</p>
//           <hr className="w-full h-[1.5px] bg-gray-700 hidden" />
//         </NavLink>
//       </ul>
